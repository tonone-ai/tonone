---
name: move-system
description: Design a motion system for a product — duration tokens, easing curves, and animation principles. Use when asked to "design a motion system", "define duration and easing tokens", or "document animation principles".
