---
name: shield-recon
description: Survey product features and data flows for regulatory exposure. Use when asked to "survey our regulatory exposure", "map our data flows", or "what regulations apply to us".
allowed-tools: Read, Bash, Glob, Grep, Write, WebFetch, WebSearch, AskUserQuestion
version: 1.2.0
author: tonone-ai <hello@tonone.ai>
license: MIT
compatibility: Designed for Claude Code
tags: [legal, regulatory, recon]
---
...
Recon: map product data flows and identify regulatory triggers.
