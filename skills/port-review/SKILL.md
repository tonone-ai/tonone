---
name: port-review
description: Review an existing SDK for idiomatic quality, consistency, and developer ergonomics. Use when asked to "review this SDK", "is our SDK idiomatic", or "assess SDK developer ergonomics".
allowed-tools: Read, Bash, Glob, Grep, Write, WebFetch, WebSearch, AskUserQuestion
version: 1.6.0
author: tonone-ai <hello@tonone.ai>
license: MIT
compatibility: Designed for Claude Code
tags: [devex, sdk, review]
---
