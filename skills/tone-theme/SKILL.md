---
name: tone-theme
description: Build or fix a theming system — dark mode, multi-brand, or white-label token swap. Use when asked to "add dark mode", "set up multi-brand theming", or "white-label the UI".
