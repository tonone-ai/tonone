---
name: audit-recon
description: Survey legal artifacts for audit readiness. Use when asked "are we audit ready", "what legal artifacts exist", or "survey our legal docs".
...
Recon: assess legal artifact completeness and audit readiness.
