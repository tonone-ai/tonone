---
name: frame-board
description: Draft board resolutions, consent documents, and meeting minutes. Use when asked to "draft a board resolution", "write board minutes", or "prepare a board consent".
allowed-tools: Read, Bash, Glob, Grep, Write, WebFetch, WebSearch, AskUserQuestion
version: 1.2.0
author: tonone-ai <hello@tonone.ai>
license: MIT
compatibility: Designed for Claude Code
tags: [legal, governance, board]
---
