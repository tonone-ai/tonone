---
name: score-compare
description: Compare two or more models statistically — significance testing and error analysis. Use when asked "which model is better", "is this improvement significant", or "compare model performance".
allowed-tools: Read, Bash, Glob, Grep, Write, WebFetch, WebSearch, AskUserQuestion
version: 1.4.0
author: tonone-ai <hello@tonone.ai>
license: MIT
compatibility: Designed for Claude Code
tags: [data-science, evaluation, compare]
---
