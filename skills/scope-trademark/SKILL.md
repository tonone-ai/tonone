...
description: Trademark clearance research and filing preparation for a name or mark. Use when asked to "clear this trademark", "can we use this name", or "prepare a trademark filing".
...
Trademark research: assess registrability, identify conflicts, prepare filing summary.
