---
name: frame-equity
description: Draft equity plan documents — option grants, vesting schedules, 409A notes. Use when asked to "draft an option grant", "write a vesting schedule", or "prepare 409A paperwork".
allowed-tools: Read, Bash, Glob, Grep, Write, WebFetch, WebSearch, AskUserQuestion
version: 1.2.0
author: tonone-ai <hello@tonone.ai>
license: MIT
compatibility: Designed for Claude Code
tags: [legal, governance, equity]
---
...
Draft equity-related docs: option grant agreement, vesting schedule, cliff provisions.
