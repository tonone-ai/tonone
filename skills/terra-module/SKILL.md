---
name: terra-module
description: Design a Terraform module structure — inputs, outputs, resource organization, and versioning. Use when asked to "design a Terraform module", "structure our IaC", or "set up module versioning".
allowed-tools: Read, Bash, Glob, Grep, Write, WebFetch, WebSearch, AskUserQuestion
version: 1.7.0
author: tonone-ai <hello@tonone.ai>
license: MIT
compatibility: Designed for Claude Code
tags: [infrastructure, terraform, iac, module]
---
