...
description: Instrument LLM calls with tracing — span structure, token counts, latency, model metadata. Use when asked to "add tracing to our LLM calls", "log prompts and completions", or "instrument token counts".
