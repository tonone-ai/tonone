---
name: shield-respond
description: Draft regulatory response letter or regulator communication. Use when asked to "respond to a regulator", "draft a regulator letter", or "reply to this inquiry".
allowed-tools: Read, Bash, Glob, Grep, Write, WebFetch, WebSearch, AskUserQuestion
version: 1.2.0
author: tonone-ai <hello@tonone.ai>
license: MIT
compatibility: Designed for Claude Code
tags: [legal, regulatory, respond]
---
...
Draft a response to a regulatory inquiry, warning letter, or enforcement notice.
