---
name: scope-recon
description: Survey project IP assets — trademarks, patents, OSS licenses, assignments. Use when asked to "survey our IP assets", "what trademarks do we hold", or "inventory our IP".
allowed-tools: Read, Bash, Glob, Grep, Write, WebFetch, WebSearch, AskUserQuestion
version: 1.2.0
author: tonone-ai <hello@tonone.ai>
license: MIT
compatibility: Designed for Claude Code
tags: [legal, ip, trademark, recon]
---
...
Recon: identify IP assets, license obligations, and assignment gaps.
