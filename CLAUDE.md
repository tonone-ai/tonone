...
**Read `docs/repomap.md` first** — this repo is too big to crawl by hand (100 agents, 427 skills). It points to `docs/agent-index.json` and `docs/skill-index.json` for lookups, and lists known content drift to watch for.
